    ...
    return (
        <>
            ...
            <section className={`${isModalOpen?"hidden":""} md:hidden h-screen flex flex-col justify-center items-center`}>
                <h1 className="font-bold tracking-tighter text-[15vw] text-center leading-[.75]">DUNGEON<br />ESCAPE</h1>
            </section>
            {/* DESKTOP */}
            <section className="hidden md:block h-[1000vh] w-full relative z-10" ref={scrollRef}>
                <div className="h-screen flex items-center justify-center flex-col gap-4">
                    <h1 className="font-bold tracking-tighter text-[15vw] text-center strokeText leading-[.75]">DUNGEON<br />ESCAPE</h1>
                ...
                <div className="h-screen flex items-center justify-center flex-col gap-4">
                    <h1 className="font-bold tracking-tighter text-[15vw] text-center leading-[.75] strokeText">DUNGEON<br />ESCAPE</h1>
                </div>
                ...
                <div className="h-screen flex justify-end gap-4 container px-8 mx-auto">
                    <div className="h-full w-1/2 flex flex-col justify-center">
                        ...
                        <p className="mt-4 opacity-70">
                            ...
                            <br />
                            It started out as a project for The Brackeys Game Aug 2024.2. I decided to keep working on it after the jam. It eventually turned into a full fledged game with a story and a lot of content.
                        </p>
                    </div>
                </div>
                <div className="h-screen flex justify-start gap-4 container px-8 mx-auto">
