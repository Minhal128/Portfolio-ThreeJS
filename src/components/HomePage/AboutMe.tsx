...
export default function AboutMe(props:{sectionRef:React.RefObject<HTMLDivElement>})
{
    ...
    const alias = "IAMMINHAL128MINHAL128MINHAL128MINHAL128";
    const bday = "404NOTFOUND404NOTFOUND404NOTFOUND404NOTFOUND";
    ...
    return (
        <div ref={props.sectionRef} className="relative">
            <ScrollIndicator>
                <h1 className="text-xs opacity-50">HELLO WORLD</h1>
            </ScrollIndicator>
            ...
            <div className="md:container md:mx-auto flex flex-row items-end gap-8 px-8">
                <div className='w-full lg:w-3/4'>
                    <div className="overflow-y-clip">
                        <h1 ref={MeRef[0]} className='text-xl sm:text-5xl font-extrabold mt-1'>MINHAL <span className='gradient-text'>RIZVI</span></h1>
                    </div>
                    <hr className='border-primary border-2 mt-4'/>
                    <div className="mt-4 flex flex-wrap gap-1">
                        {
                            ["Frontend Developer","Mobile Developer","Designer","Cyber Tool Developer"].map((value,index)=>{
                    ...
                    I am a full-stack Software Engineer and freelancer actively seeking online projects, with a strong focus on creating innovative cyber tools. I am a quick learner, adept at solving critical challenges, and thrive on approaching professional problems with a neutral, innovative, and solution-oriented perspective..
                    </p>
                </div>
