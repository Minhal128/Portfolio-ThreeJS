        ...
        <section className="h-screen flex flex-col items-center justify-between p-4 sm:pt-36 pb-16">
            ...
            <div style={{translate:`-${(phaseIndex)}00vw 0`}} className="w-[300vw] h-full flex transition-all duration-500">
                <div className="w-[100vw] h-full relative flex flex-col justify-center items-center">
                    ...
                    <h1 className='text-5xl lg:text-8xl font-bold tracking-tighter text-center'>DUNGEON ESCAPE</h1>
                ...
                <div className="w-[100vw] h-full relative flex flex-col md:flex-row sm:justify-center items-center p-4 lg:px-32 xl:px-64">
                    ...
                    <div className="w-full flex flex-col justify-center">
                        <h1 className='animate left font-black text-6xl md:text-9xl leading-tight'>SPYSEE<span className='accent-gradient background-clip-text'>.</span></h1>
                        <h1 className='animate left delay-1 font-extrabold text-2xl md:text-5xl leading-tight'>It's an <span className='accent-gradient background-clip-text'>Cyber Tool.</span></h1>
                        <p className='animate left delay-2 font-light opacity-70 text-sm md:text-base mt-2'>Gather images and instant keylogs for me, new social spyware!</p>
                        <div className="flex gap-4 mt-4">
                            <a href='https://github.com/Minhal128/SPYSEE' target='_blank' className='bg-[#faa214] w-64 rounded-xl px-4 py-2.5 md:py-4 md:px-6 hover:scale-105 transition-transform active:scale-95 text-xs md:text-base grid place-content-center'>VISIT</a>
                        </div>
                    </div>
                </div>
                <div className="w-[100vw] h-full relative flex flex-col justify-center items-center">
